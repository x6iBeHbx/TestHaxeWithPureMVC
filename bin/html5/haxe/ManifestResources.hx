...
@:keep @:bind #if display private #end class __ASSET__img_fortest_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_iconsstatic_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_myspritesheet_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_test_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_test2_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_test3_xml extends null { }
@:keep @:bind #if display private #end class __ASSET__json_resourcepath_json extends null { }
@:keep @:bind #if display private #end class __ASSET__json_slot_test_json extends null { }
