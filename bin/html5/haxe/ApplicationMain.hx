...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		var projectName = "TestSlotOnPureMvc";
		
		var config = {
			
			build: "1",
			company: "Andrii Andriushchenko",
			file: "TestSlotOnPureMvc",
			fps: 60,
			name: "TestSlotOnPureMvc",
			orientation: "",
			packageName: "TestSlotOnPureMvc",
			version: "1.0.0",
			windows: [
